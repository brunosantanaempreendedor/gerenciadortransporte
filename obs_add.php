  ...
  if(isset($_POST['adicionar_obs']))
    {
      ...
      $texto              = $_POST['texto'];
        ...
        if($observacoes->cadastro($codigo,$associado,$data_atual))
        {
                    ...
                    <form id="" data-parsley-validate class="form-horizontal form-label-left" method="post">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                          <label class="control-label" for="Nome">Associado
                          </label>
                      ...
                      <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="form-group">
                            <label class="control-label" for="contribuicao">Observação:
                            </label>
                      ...
                      <div class="form-group">
                        <div class="col-md-4 col-sm-4 col-xs-12 col-md-offset-8">
                          ...
                          <input type=hidden name='adicionar_obs' value='true'>
                        </div>
                      </div>
