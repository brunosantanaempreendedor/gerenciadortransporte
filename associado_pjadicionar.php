  ...
  if(isset($_POST['adicionar_empresa']))
    {
      ...
      $status             = $_POST['status'];
        ...
        if($associados->cadastropj($nr_associado,$razao_social,$rua,$numero,$complemento,$bairro,$cep,$cidade,$uf,$email,$telefone,$celular1,$celular2,$cnpj,$ie,$status))
        {
          header("Location: associados.php");
        }
        else
        {
          header("Location: associado_pjadicionar.php?erro");
        }
    }
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Novo Associado P. Jurídica</h3>
              </div>
                    ...
                    <form id="" data-parsley-validate class="form-horizontal form-label-left" method="post">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control col-md-7 col-xs-12" name='cnpj' id="cnpj" required="true">
                        </div>
                      </div>
