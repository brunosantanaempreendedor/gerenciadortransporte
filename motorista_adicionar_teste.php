  ...
  if(isset($_POST['adicionar_motorista']))
    {
      ...
      $nasc               = str_replace("/", "-", $_POST['nascimento']);
      $nascimento         = date('Y-m-d', strtotime($nasc));
      $naturalidade       = $_POST['natural'];
      $natural_uf         = $_POST['natural_uf'];
      $cnh                = $_POST['cnh'];
      $val                = str_replace("/", "-", $_POST['validade']);
      $validade           = date('Y-m-d', strtotime($val));
      $senha_detran       = $_POST['senha_detran'];
      $curso              = $_POST['curso'];
      $particular         = $_POST['particular'];
      $gratuito           = $_POST['gratuito'];
      
        if($motoristas->cadastro($nr_associado,$nome,$rua,$numero,$bairro,$cep,$cidade,$uf,$email,$telefone,$celular1,$celular2,$mae,$pai,$cpf,$estado_civil,$rg,$orgao_exp,$nascimento,$naturalidade,$natural_uf,$cnh,$validade,$senha_detran,$curso,$particular,$gratuito))
        {
                    ...
                    <form id="" data-parsley-validate class="form-horizontal form-label-left" method="post">
                      ...
                      <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group">
                          <label class="control-label" for="nr_associado">Motorista Associado
                          </label>                          
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                          <label class="control-label" for="Nome">Nome Motorista Preposto
                          </label>
