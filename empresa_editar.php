  ...
  if(isset($_POST['editar_empresa']))
    {
      ...
      $ie                 = $_POST['ie'];
        ...
        if($empresas->editar($a_id,$nr_associado,$razao_social,$rua,$numero,$bairro,$cep,$cidade,$uf,$email,$telefone,$celular1,$celular2,$cnpj,$ie))
        {
          header("Location: empresas.php");
        }
        else
        {
          header("Location: empresas_editar.php?erro");
        }
    }
