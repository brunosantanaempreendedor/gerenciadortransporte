<?php 
  ...
  if(isset($_POST['adicionar_vistoria']))
    {
      ...
      $gratuito           = $_POST['gratuito'];
        ...
        if($vistorias->cadastro($nr_associado,$alvara,$autorizacao,$tacografo,$inmetro,$particular,$gratuito))
        {
          header("Location: vistorias.php");
        }
        else
        {
          header("Location: vistoria_adicionar.php?erro");
        }
    }
                    ...
                    <form id="" data-parsley-validate class="form-horizontal form-label-left" method="post">
                      ...
                      <div class="form-group">
                        <div class="col-md-4 col-sm-4 col-xs-12 col-md-offset-8">
                          ...
                          <input type=hidden name='adicionar_vistoria' value='true'>
                        </div>
                      </div>
