              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                      ...
                      <div class="col-md-1 col-md-offset-11">
                        <span>
                            <button type="button" class="btn btn-success" data-toggle="modal" data-placement="top" data-target="#Diversos" title="Pagamento Diverso">
...
<div class="modal fade" id="Diversos" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Cadastrar Pagamentos Diversos</h4>
      </div>
      ...
      <fieldset>
        <form  class="diversos">
                  <div class="row">
                    <div class="form-group">
                      ...
                      <input type="hidden" class="form-control" name="pdiversos_add" id="pdiversos_add" value="true">
                      </div>  
                    </div>
                    </div>
        </form>
       ...
       <div class="modal-footer">
          <button type="button" class="btn btn-success" id="cadPDiversos">
  ...
  $("button#cadPDiversos").click(function(){
        $("#cadPDiversos").prop('disabled', true);
        $("#cadPDiversos").html('Processando...');
        $.ajax({
            type: "POST",
            url: "process.php",
            data: $('form.diversos').serialize(),
            success: function(msg){
                $("#cadPDiversos").prop('disabled', false);
                $("#cadPDiversos").html('SALVAR');
                $("#tipo").val('');
                $("#valor").val('');
                $("#data").val('');
                $("#Diversos").modal('hide');
