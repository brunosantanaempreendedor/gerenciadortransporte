<?php 
  ...
  if(isset($_POST['adicionar_associado']))
    {
      ...
      $status             = $_POST['status'];
        ...
        if($associados->cadastro($nr_associado,$nome,$rua,$numero,$complemento,$bairro,$cep,$cidade,$uf,$email,$telefone,$celular1,$celular2,$mae,$pai,$cpf,$estado_civil,$rg,$orgao_exp,$nascimento,$naturalidade,$natural_uf,$cnh,$validade,$senha_detran,$curso,$obs,$particular,$gratuito,$data_inclusao,$data_desligamento,$crm,$status))
        {
          header("Location: associados.php");
        }
        else
        {
          header("Location: associado_adicionar.php?erro");
        }
    }
...
<html lang="en">
  ...
  <body class="nav-md">
                    ...
                    <form id="" data-parsley-validate class="form-horizontal form-label-left" method="post">
                      ...
                      <div class="col-md-2 col-sm-2 col-xs-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control col-md-7 col-xs-12" name='nr_associado' id="nr_associado" >
                        </div>
                      </div>
                      ...
                      <div class="col-md-2 col-sm-2 col-xs-12">
                        <div class="form-group">
                            ...
                            <div class='input-group date' id='myDatepicker0'>
                                <input type='text' class="form-control col-md-7 col-xs-12" name='nascimento' id="nascimento" value="">
                      ...
                      <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control col-md-7 col-xs-12" name='cpf' id="cpf" data-inputmask="'mask' : '999.999.999-99'" required="true">
                        </div>
                      </div>                        
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <textarea name="obs" id="obs" cols="30" class="form-control col-md-7 col-xs-12" rows="10"></textarea>
                      ...
                      <div class="col-md-2 col-sm-2 col-xs-12">
                        <div class="form-group">
                            ...
                            <div class='input-group date' id='myDatepicker1'>
                                <input type='text' class="form-control col-md-7 col-xs-12" name='data_inclusao' id="data_inclusao">
                                <span class="input-group-addon">
                                   <span class="glyphicon glyphicon-calendar"></span>
                                </span>
                            </div>
                      ...
                      <div class="col-md-2 col-sm-2 col-xs-12">
                        <div class="form-group">
                            ...
                            <div class='input-group date' id='myDatepicker2'>
                                <input type='text' class="form-control col-md-7 col-xs-12" name='data_desligamento' id="data_desligamento">
                                <span class="input-group-addon">
                                   <span class="glyphicon glyphicon-calendar"></span>
                                </span>
                            </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-4 col-sm-4 col-xs-12 col-md-offset-8">
                          ...
                          <input type=hidden name='adicionar_associado' value='true'>
                        </div>
                      </div>
    ...
    <script src="build/js/custom.min01.js"></script>
