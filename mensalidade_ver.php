  ...
  if(isset($_GET['del_id']))
{
  ...
  $asc  = $_GET['asc'];
  $entradas->delID($id);
  header("Location: mensalidade_ver.php?id=$asc"); 
}
                ...
                <div class="x_panel">
                      ...
                      <div class="col-md-3 col-md-offset-9">
                        <span>
                            ...
                            <button type="button" class="btn btn-success" data-toggle="modal" data-placement="top" data-target="#Mensal" title="Lançar Mensalidade" data-whatever="<?php echo $edit->codigo; ?>">
...
<div class="modal fade" id="Mensal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    ...
    function conferir()
      ...
      $('#Mensal').on('show.bs.modal', function (event) {
