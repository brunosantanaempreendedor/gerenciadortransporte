  ...
  if(isset($_POST['editar_motorista']))
    {
      ...
      $crm                = $_POST["crm"];
        ...
        if($motoristas->editar($a_id,$nr_associado,$nome,$rua,$numero,$bairro,$cep,$cidade,$uf,$email,$telefone,$celular1,$celular2,$mae,$pai,$cpf,$estado_civil,$rg,$orgao_exp,$nascimento,$naturalidade,$natural_uf,$cnh,$validade,$senha_detran,$curso,$particular,$gratuito,$crm))
        {
          header("Location: motoristas.php");
        }
        else
        {
          header("Location: motorista_editar.php?erro");
        }
    }
                    ...
                    <form id="" data-parsley-validate class="form-horizontal form-label-left" method="post">
                        ...
                        <div class="form-group">
                          ...
                          <select name="nr_associado" id="nr_associado" class="form-control col-md-7 col-xs-12">
                            <option value="<?php echo $edit->nr_associado; ?>">
                              <?php $id = $edit->nr_associado; $nrAss = $associados->getID($id); echo $nrAss->nome; echo $nrAss->razao_social; ?>
                            </option>
                            <option value=""></option>
                            <?php foreach ($associados->findAll() as $key => $value) { ?>
                            <option value="<?php echo $value->id; ?>"><?php echo $value->nome; echo $value->razao_social; ?></option>
                            <?php } ?>
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control col-md-7 col-xs-12" name='cep' id="cep" data-inputmask="'mask' : '99999-999'"  value="<?php echo $edit->cep; ?>" >
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-1 col-sm-1 col-xs-12 col-md-offset-11">
                          ...
                          <input type=hidden name='editar_motorista' value='true'>
