              ...
              <div class="col-md-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div class="row">
                    <div class="col-md-10">
                    <h4>Arraste a imagem para a caixa abaixo ou clique para selecionar.</h4>
                    </div>
                    <div class="col-md-2">
                          <span>
                               <a href="index.php" class="btn btn-success"><i class="fa fa-angle-double-left"></i> VOLTAR</a>
                          </span>
                    </div>
                    </div>

                    <form class="dropzone" method="post" action="upload_cab.php" enctype="multipart/form-data">
