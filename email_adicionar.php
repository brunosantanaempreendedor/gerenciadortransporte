<?php 
  ...
  if(isset($_POST['adicionar_email']))
    {
      $codigo       = $_POST['codigo'];
      $email        = $_POST['email'];
      
        if($emails->cadastro($codigo,$email))
        {
          header("Location: emails.php");
        }
        else
        {
          header("Location: email_adicionar.php?erro");
        }
    }
                    ...
                    <form id="" data-parsley-validate class="form-horizontal form-label-left" method="post">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" required="required" class="form-control col-md-7 col-xs-12" name='email' id="email" >
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-4 col-sm-4 col-xs-12 col-md-offset-8">
                          ...
                          <input type=hidden name='adicionar_email' value='true'>
                        </div>
                      </div>
