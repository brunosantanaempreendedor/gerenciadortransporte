  ...
  if(isset($_POST['editar_veiculo']))
    {
      ...
      $proprietario       = $_POST['proprietario'];
        ...
        if($veiculos->editar($a_id,$nr_associado,$prefixo,$placa,$marca,$modelo,$renavam,$chassi,$cap,$cor,$ano_fab,$ano_mod,$prefeitura,$alvara,$autorizacao,$tacografo,$inmetro,$proprietario))
        {
          header("Location: veiculos.php");
        }
        else
        {
          header("Location: veiculo_editar.php?erro");
        }
    }
                    ...
                    <form id="" data-parsley-validate class="form-horizontal form-label-left" method="post">
                        ...
                        <div class="form-group">
                          ...
                          <select name="nr_associado" id="nr_associado" class="form-control col-md-7 col-xs-12">
                            <option value="<?php echo $edit->nr_associado; ?>">
                              <?php
                              $id     = $edit->nr_associado;
                              $nrAss  = $associados->getID($id);

                                if (!$nrAss->nome == 0) {echo $nrAss->nome;} else {}
                                if (!$nrAss->razao_social == 0) {echo $nrAss->razao_social;} else {}
                      ...
                      <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control col-md-7 col-xs-12" name='prefixo' id="prefixo" value="<?php echo $edit->prefixo; ?>" >
                        </div>
                      </div>
                      ...
                      <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control col-md-7 col-xs-12" name='placa' id="placa" value="<?php echo $edit->placa; ?>" >
                        </div>
                      </div>
                      ...
                      <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control col-md-7 col-xs-12" name='marca' id="marca" value="<?php echo $edit->marca; ?>" >
                        </div>
                      </div>
                      ...
                      <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control col-md-7 col-xs-12" name='modelo' id="modelo" value="<?php echo $edit->modelo; ?>" >
                        </div>
                      </div>
                      ...
                      <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control col-md-7 col-xs-12" name='renavam' id="renavam" value="<?php echo $edit->renavam; ?>" >
                        </div>
                      </div>
                      ...
                      <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control col-md-7 col-xs-12" name='chassi' id="chassi" value="<?php echo $edit->chassi; ?>" >
                        </div>
                      </div>
                      ...
                      <div class="col-md-2 col-sm-2 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control col-md-7 col-xs-12" name='cap' id="cap" value="<?php echo $edit->cap; ?>" >
                        </div>
                      </div>
                      ...
                      <div class="col-md-2 col-sm-2 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control col-md-7 col-xs-12" name='cor' id="cor" value="<?php echo $edit->cor; ?>" >
                        </div>
                      </div>
                      ...
                      <div class="col-md-2 col-sm-2 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control col-md-7 col-xs-12" name='ano_fab' id="ano_fab" value="<?php echo $edit->ano_fab; ?>" >
                        </div>
                      </div>
                      ...
                      <div class="col-md-2 col-sm-2 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control col-md-7 col-xs-12" name='ano_mod' id="ano_mod" value="<?php echo $edit->ano_mod; ?>" >
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control col-md-7 col-xs-12" name='prefeitura' id="prefeitura"  value="<?php echo $edit->prefeitura; ?>" >
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                          <label class="control-label" for="proprietario">Proprietário
                          </label>
                          <select name="proprietario" id="proprietario" class="form-control col-md-7 col-xs-12">
                            <option value="<?php echo $edit->proprietario; ?>">
                              <?php
                      ...
                      <div class="form-group">
                        <div class="col-md-2 col-sm-2 col-xs-12 col-md-offset-10">
                          ...
                          <input type=hidden name='editar_veiculo' value='true'>
                        </div>
                      </div>
